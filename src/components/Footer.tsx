          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              {!subscribed ? (
                ...
                <p className="text-green-500 text-sm font-semibold mt-3">
              ...
              <div className="mt-6">
                ...
                <div className="flex gap-3">
                  {[
                    {
                      name: "LinkedIn",
                      url: "https://www.linkedin.com/company/wtero-tech/",
                      icon: <Linkedin className="w-6 h-6" />
                    },
                    {
                      name: "Whatsapp",
                      url: "https://www.whatsapp.com/channel/0029Vb6tHAc0wajyJV4Wfu1s",
                      icon: <MessageCircle className="w-6 h-6" />
                    },
                    {
                      name: "Facebook",
                      url: "https://www.facebook.com/share/1CsFxqg4YD/",
                      icon: <Facebook className="w-6 h-6" />
                    },
                    {
                      name: "Instagram",
                      url: "https://www.instagram.com/wteroofficial/",
